...
namespace ChillHub.Core.Sync
{
    public class Manifest
    {
        ...
        [JsonPropertyName("buildId")] public string BuildId { get; set; } = string.Empty;
        ...
        [JsonPropertyName("emptyDirs")] public List<string> EmptyDirs { get; set; } = new();
    ...
    public class ManifestFile
    {
        ...
        [JsonPropertyName("blake3")] public string Blake3 { get; set; } = string.Empty;
