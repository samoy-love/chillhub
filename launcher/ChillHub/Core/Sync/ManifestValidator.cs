    ...
    public static class ManifestValidator {
        ...
        public static void Validate(Manifest manifest, string source) {
            ...
            for (var i = 0; i < dirs.Count; i++) {
                ...
                // "a/b" описывают ОДИН каталог, и планировщик кладёт в план ту же
                // канонизированную форму (ManifestPath.Canonicalize), которую мы здесь
                // проверяем, — то есть проверяем и используем одно и то же. Для файлов
                // такая вольность недопустима — там строка решает, какой именно файл
                // окажется на диске, — но для каталога выбора нет.
                //
