...
namespace ChillHub.Core.Maintenance {
    ...
    public static class MaintenanceService {
        ...
        /// <para>
        /// ВНИМАНИЕ: значение ПРЕДПОЛОЖИТЕЛЬНОЕ. Серверная часть задачи 25 делается
        /// параллельно — сверить путь и форму ответа (см. <see cref="MaintenanceState"/>)
        /// с реализацией сервера и поправить здесь, если они разошлись.
        /// </para>
        /// </summary>
