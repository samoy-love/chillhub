...
namespace ChillHub.Tests {
    ...
    public class ChangelogTests {
        ...
        /// <summary>
        /// Имена, у которых русского написания нет: их латиница законна. Всё остальное
        /// латиницей — либо непереведённый термин, либо код ошибки, который игроку
        /// показывать нечего.
        /// </summary>
        private static readonly string[] AllowedLatinNames = {
            "Chill Hub", "Steam", "Windows", "FreeTP", "Thunderstore",
        };
