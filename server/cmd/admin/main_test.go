...
var wantPaths = []string{
	...
	"/admin/api/games/ecosystem",
	"/admin/api/mods/activate",
	"/admin/api/mods/build",
	"/admin/api/mods/cache",
	"/admin/api/summary",
	"/admin/api/mods/catalog",
	"/admin/api/mods/deleteVersion",
	"/admin/api/mods/diff",
	...
	"/admin/games/save",
	"/admin/games/ecosystem",
	"/admin/mods/activate",
	"/admin/mods/cache",
	"/admin/summary",
	"/admin/mods/catalog",
	"/admin/mods/deleteVersion",
	"/admin/mods/diff",
	"/admin/mods/list",
	"/admin/mods/readme",
	"/admin/mods/resolve",
