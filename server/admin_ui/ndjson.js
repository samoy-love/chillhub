// Чтение потока NDJSON — отдельным CommonJS-модулем, как chunk-upload.js:
// только такой файл c8 видит построчно.
//
// ПОЧЕМУ ВЫНЕСЕНО: разбор потока был написан в runChunkedUpload
