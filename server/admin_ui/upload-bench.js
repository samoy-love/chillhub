// Тестируемое ядро инструмента подбора параметров загрузки (раздел «Диск и
// загрузки», карточка прогона). Отдельным файлом, а не частью admin.js:
// обычный CommonJS-модуль `require()`-ится как есть, и c8 видит его
// построчно — считающий код в этом каталоге живёт так весь.
//
// В браузере файл подключается отдельным <script> ДО admin.js и кладёт те же
// имена в window; admin.js зовёт их как глобальные, как и остальные модули
// рядом.
