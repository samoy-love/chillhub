...
export default [
  // Global ignore patterns (migrated from .eslintignore)
  {
    ignores: [
      ...
      '**/*.min.css',
      'content/',
      // Рабочие каталоги, которых нет в git (см. .gitignore): результаты сборки и
      // черновики панели. В чистом клоне их не существует, поэтому CI был зелёным, а
      // локальный `make lint-web` выдавал полсотни ошибок в файлах, которых никто не
      // правил, — и настоящие замечания тонули среди них.
      'build/',
      'stage-*/'
    ]
  },
