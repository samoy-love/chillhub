...
| `docs/` | [Спецификация](docs/spec.md), [конфигурация](docs/configuration.md), [подпись установщика](docs/installer-signing.md), [политика безопасности](docs/SECURITY.md) |
