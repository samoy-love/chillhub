# Техническое задание (ТЗ) — Chill Hub (MVP)
...
- ~~Клиентская часть метрик~~ — сделано: лаунчер шлёт запуски, установки, обновления, запуски и сессии игр, проверки целостности и ошибки (см. [8.6](#86-метрики-лаунчера)).
