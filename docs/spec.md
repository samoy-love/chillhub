...
- Метрики отправляются лаунчером и принимаются сервером; сводка в админке заполнена. Тумблер «отправлять статистику» в настройках лаунчера выключает отправку целиком.
